...
```{r herd_plot_out, eval = F, echo = FALSE}
p <- herd_plot(master_tb, "x1234567") #fake herd
p
```

```{r herdplotfigure, echo = F, eval = T, include=F, warning = F, out.width="100%", out.width="100%", fig.cap = "Herd plot"}
knitr::include_graphics(paste0(getwd(), "/data/herd_plot_figure.png")) #works in chunk but not when you render
